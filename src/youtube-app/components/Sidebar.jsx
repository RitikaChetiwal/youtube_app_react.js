  ...
  return (
    <div className="sidebar">
      <div className="sidebar-section">
        <div className='option' style={{ display: 'flex', fill: 'currentColor', gap: '15px', alignItems: "center" }}>
          <svg
      ...
      <div className="sidebar-section">
        ...
        <div className='option' style={{ display: 'flex', fill: 'currentColor', gap: '15px', alignItems: "center" }}>
          ...
          <div className="text">Your videos</div>
        </div>
        ...
        <div className='option' style={{ display: 'flex', fill: 'currentColor', gap: '15px', alignItems: "center" }}>
          ...
          <div className="text">Your courses</div>
        </div>
        ...
        <div className='option' style={{ display: 'flex', fill: 'currentColor', gap: '15px', alignItems: "center" }}>
          ...
          <div className="text">Watched later</div>
        </div>
